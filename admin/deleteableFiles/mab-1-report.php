        ...
        <?php require_once('../assets/components/admin/sidebar.php'); ?>
                ...
                <section class="content">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <?php if (isset($_GET['route']) && !empty($_GET['route']) && $_GET['route'] == "mab-1-report") { ?>
                                        <div class="card-header bg-dark">
                                            <h3 class="card-title"><i class="fa-solid fa-newspaper me-2"></i>Health Declaration Forms</h3>
                                        </div>
                                        <div class="card-body overflow-auto">

                                            <table id="mab1ReportsTable" class="table table-bordered" style="width:100%">
            ...
            <script>
                $(document).ready(function () { 
                    // TODO Table First
                    var mab1ReportsTable = $('#mab1ReportsTable').DataTable({
                        "ordering": false,
