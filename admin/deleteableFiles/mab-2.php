...
<body class="hold-transition sidebar-mini layout-fixed sidebar-collapse layout-navbar-fixed">
    <div class="wrapper">
        ...
        <input type="hidden" value="<?php echo $buildingUniqueId ?? "" ?>" id="buildingUniqueId">
                                    ...
                                    <select class="form-select" style="height: 3.6rem;" id="userBuilding" name="userBuilding" onchange="this.options[this.selectedIndex].value && (window.location = this.options[this.selectedIndex].value);">
                                        ...
                                        <?php if (!empty($buildings)) { ?>
                                            <?php foreach ($buildings as $building) { ?>
                                                ...
                                                <?php } else { ?>  
                                                    <option value="<?php echo "index?route=mab-2&buid=".$building['buildingUniqueId'] ?? "";  ?>"><?php echo $building['buildingName'] ?? "";  ?></option>
                ...
                <section class="content">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <?php if (isset($_GET['route']) && !empty($_GET['route']) && $_GET['route'] == "mab-2" && isset($_GET['view']) && !empty($_GET['view'])) { ?>
                                        <?php 
                                    ...
                                    <?php } else if (isset($_GET['route']) && !empty($_GET['route']) && $_GET['route'] == "mab-2") { ?>
                                        <div class="card-header bg-dark">
                                            <h3 class="card-title"><i class="fa-solid fa-newspaper me-2"></i>Health Declaration Forms</h3>
                                        </div>
                                        <div class="card-body overflow-auto">

                                            <table id="mab2Table" class="table table-bordered" style="width:100%">
            ...
            <script>
                // console.log(buildingUniqueId);

                $(document).ready(function () { 
                    // TODO Table First
                    const buildingUniqueId = $('#buildingUniqueId').val(); 
                    var mab2Table = $('#mab2Table').DataTable({
                        "ordering": false,
                        "ajax": '../partials/php/get-queue-mab2.php?buid='+buildingUniqueId,
                        "columns": [
                            {data: "declarationId"},
                            {data: "userFullName"},
                    ...
                    setInterval( function () {
                        mab2Table.ajax.reload( null, false );
                    }, 3000 );
                });
            </script>
        </div>
