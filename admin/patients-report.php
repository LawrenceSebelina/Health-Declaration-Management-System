...
<head>
    ...
    <title>
        <?php if (isset($_GET['route']) && !empty($_GET['route']) && $_GET['route'] == "patients-report" && isset($_GET['view']) && !empty($_GET['view'])) { ?>
            View Patient Personal Data
        <?php } else { ?>
            Patients Data Report
        <?php } ?>
    </title>
</head>
        ...
        <?php require_once('../assets/components/admin/sidebar.php'); ?>
                ...
                <section class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <?php if (isset($_GET['route']) && !empty($_GET['route']) && $_GET['route'] == "patients-report" && isset($_GET['view']) && !empty($_GET['view'])) { ?>
                                    <h1>View Patient Personal Data</h1>
                                <?php } else if (isset($_GET['route']) && !empty($_GET['route']) && $_GET['route'] == "patients-report") { ?>
                            ...
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    <?php if (isset($_GET['route']) && !empty($_GET['route']) && $_GET['route'] == "patients-report" && isset($_GET['view']) && !empty($_GET['view'])) { ?>
                                        <li class="breadcrumb-item"><a href="index.php?route=patients-report">Patients Data Report</a></li>
                                        <li class="breadcrumb-item active">View Patient Personal Data</li>
                                    <?php } else if (isset($_GET['route']) && !empty($_GET['route']) && $_GET['route'] == "patients-report") { ?>
                                        <li class="breadcrumb-item active">Patients Data Report</li>
                                    <?php } ?>
                                </ol>
                            </div>
                        </div>
                                ...
                                <div class="card">
                                    <?php if (isset($_GET['route']) && !empty($_GET['route']) && $_GET['route'] == "patients-report" && isset($_GET['view']) && !empty($_GET['view'])) { ?>
                                        <?php 
                                            ...
                                            $patientDatas = $class->getPatientsGuestsDataReport($userUniqueId);
                                            
                                            if (!empty($patientDatas)) {
                                                foreach ($patientDatas as $patientData) {
                                                    $userUniqueId = $patientData['userUniqueId'];
                                                    $userFullName = $patientData['userFName'] . " " . $patientData['userMI'] . ". " . $patientData['userLName'];
                                                    $userType = $patientData['userType'];
                                                    $userAge = $patientData['userAge'];
                                                    $userGender = $patientData['userGender'];
                                                    $userAddress = $patientData['userAddress'];
                                                    $userContactNo = $patientData['userContact'];
                                                    $userUsername = $patientData['userUsername'];
                                                    $userEmail = $patientData['userEmail'];
                                                    $userBirthday = date('F d, Y', strtotime($patientData['userBDay']));
                                                    $userDateCreated = date('F d, Y', strtotime($patientData['userDateCreated']));
                                        ...
                                        <div class="card-header bg-dark">
                                            <h3 class="card-title"><i class="fa-solid fa-address-book me-2"></i>Patient Data (<?php echo $userFullName; ?>)</h3>
                                        </div>
                                        <div class="card-body overflow-auto">
                                            <div class="mt-2"><h5 class="form-title"><span>Personal Information</span></h5></div>
                                            <table id="patientDataTable" class="table table-borderless d-none" style="width:100%">
                                    ...
                                    <?php } else if (isset($_GET['route']) && !empty($_GET['route']) && $_GET['route'] == "patients-report") { ?>
                                        <div class="card-header bg-dark">
                                            <h3 class="card-title"><i class="fa-solid fa-hospital-user me-2"></i>Patients Data</h3>
                                        </div>
                                        <div class="card-body overflow-auto">

                                            <table id="patientsDataTable" class="table table-bordered" style="width:100%">
                                                <thead class="table-dark">
                                                    <tr>
                                                        <th>#</th>
                                                        <th>Name</th>
            ...
            <script>
                $(document).ready(function () { 
                    // TODO Table First
                    var patientsDataTable = $('#patientsDataTable').DataTable({
                        "ordering": false,
                        "ajax": '../partials/php/get-patients-data-report.php',
                        "columns": [
                            {data: "userId"},
                            {data: "userFullName"},
                        ...
                        dom:
                            ...
                            buttons: [
                            {
                                ...
                                messageTop: '<div class="row"><div class="col-md-4 d-flex justify-content-end align-items-center"><img class="img-fluid" width="100" height="100" src="../assets/images/my-logo.png" alt="UPHMC-B Logo" alt=""></div><div class="col-md-5 text-center mt-3 mb-2"><strong>University of Perpertual Help Medical Center - Biñan</strong><br><h6>National Hi-way Biñan Laguna</h6><h6>☏ (632) 8779-5310 / (6349) 544-5150</h6><h6>✉ hospital@phmcb.com</h6></div><div class="mb-2 mt-5 col-md-12 d-flex justify-content-center align-items-center"><h3><strong>Patients Data Report</strong></h3></div><div class="col-md-12 d-flex justify-content-center align-items-center"><h6>Prepared By: <?php echo $info['userFName'] . " " . $info['userLName'] ?? ""; ?></h6></div><div class="col-md-12 d-flex justify-content-center align-items-center"><h6>Date & Time: <?php date_default_timezone_set('Asia/Manila'); echo date('Y-m-d | h:i a') ?? ""; ?></h6></div></div>',
                                title: '',
                            },
                        ], 
                    ...
                    $('#patientDataTable').DataTable( {
                        ...
                        buttons: [
                        
                            {
                                ...
                                className: 'btn btn-success btn-flat btn-lg mb-3',
                                text: '<div class="d-flex align-items-center"><i class="fa-solid fa-print fs-5 me-2"></i><span class="fw-bold">Print</span></div>',
                                messageTop: '<div class="row"><div class="col-md-4 d-flex justify-content-end align-items-center"><img class="img-fluid" width="100" height="100" src="../assets/images/my-logo.png" alt="UPHMC-B Logo" alt=""></div><div class="col-md-5 text-center mt-3 mb-2"><strong>University of Perpertual Help Medical Center - Biñan</strong><br><h6>National Hi-way Biñan Laguna</h6><h6>☏ (632) 8779-5310 / (6349) 544-5150</h6><h6>✉ hospital@phmcb.com</h6></div><div class="mb-2 mt-5 col-md-12 d-flex justify-content-center align-items-center"><h3><strong>Patient Data (<?php echo $userFullName ?? ""; ?>)</strong></h3></div><div class="col-md-12 d-flex justify-content-center align-items-center"><h6>Prepared By: <?php echo $info['userFName'] . " " . $info['userLName'] ?? ""; ?></h6></div><div class="col-md-12 d-flex justify-content-center align-items-center"><h6>Date & Time: <?php date_default_timezone_set('Asia/Manila'); echo date('Y-m-d | h:i a') ?? ""; ?></h6></div></div>',
